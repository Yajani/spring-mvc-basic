...
//        return "/WEB-INF/views/hello.jsp";
    ...
    @RequestMapping("/food")
    public String food(){
        System.out.println("food.jsp 연다 ");
//        return "/WEB-INF/views/chap01/food.jsp";
    ...
    public String major(
            String stu,
            @RequestParam ("major") String mj, //클라이언트에서 보낸이름이랑 지역변수랑 이름이 다를경우에 ("")안에 써준다.
            @RequestParam (defaultValue = "1") int grade //기본값 = 1
    ){
        String major = "전공전공";
    ...
    public String member(
             @PathVariable String userName, // /뒤에 있는 경로를 읽음 @
    ...
    @PostMapping("/food-select") //post로만 받고싶을 때
