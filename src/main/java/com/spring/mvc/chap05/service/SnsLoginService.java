...
public class SnsLoginService {
    ...
    private void getKakaoAccessToken(Map<String, String> requestMap) {
        ...
        params.add("client_id", requestMap.get("applekey"));
        ...
        HttpEntity<Object> reqestEntity = new HttpEntity<>(headers, params);
        ...
        //응답 데이터
        ResponseEntity<Map> responseEntity = template.exchange(requestUri, HttpMethod.POST, reqestEntity, Map.class);
